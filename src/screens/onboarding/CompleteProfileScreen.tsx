...
export function CompleteProfileScreen({ role, onComplete }: CompleteProfileScreenProps) {
      ...
      >
        <View style={styles.header}>
          <Text style={styles.step}>
            {role === 'provider'
              ? t('onboarding.profile.eyebrowProvider')
              : t('onboarding.profile.eyebrowCustomer')}
          </Text>
          <Text style={styles.title}>{t('onboarding.profile.titleCustomer')}</Text>
          <Text style={styles.subtitle}>
            {role === 'provider'
              ? t('onboarding.profile.subtitleProvider')
              : t('onboarding.profile.subtitleCustomer')}
          </Text>
        </View>
